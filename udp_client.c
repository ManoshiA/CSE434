...
int main() {
    ...
    while (1) {
        ...
        {
            if(strncmp(user_input, "login#user1&password1", 15) == 0)
            {
            ...
            else if(strncmp(user_input, "login#user2&password2", 16) == 0)
            {
                //printf("login succesful");
                m = strlen(user_input) - 6;
            ...
            else if(strncmp(user_input, "login#user3&password3", 17) == 0)
            {
                //printf("login succesful");
                m = strlen(user_input) - 6;
